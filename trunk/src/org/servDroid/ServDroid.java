...
import org.servDroid.Preference.EditPreferences;
...
public class ServDroid extends ListActivity {
	...
	// This is the handler for the thread which refresh the log screen
	...
	/**
	 * This function show the help dialog
	 */
	private void showHelpDialog() {
		...
		builder.setMessage(
				...
				.setCancelable(false).setNeutralButton(R.string.accept,
	...
	/**
	 * Show logs entries in the screen
	 */
	...
	/**
	 * open a web browser to see how ServDroid works
	 */
	private void openWebBrowser() {
		Intent i = new Intent(Intent.ACTION_VIEW);
		Uri u = Uri.parse("http://127.0.0.1:" + getPort());
		i.setData(u);
		startActivity(i);
	}
	...
	/**
	 * This function show the notifications in the device
	 */
	...
	/**
	 * Get if vibrate is enable through SharedPreferences
	 * 
	 ...
	 * 
	 * Where the error documents path (404.html, etc) are stored
	 * 
	 * @return error path
	 */
