...
public class ServdroidDbAdapter extends Activity {
	...
	/**
	 * Delete table log from database
	 */
	...
	/**
	 * 
	 * NOT IMPLEMENTED. Add an IP to black list server.
	 * 
	 * @param rowIdLog
	 *            the id of log entry where contains the IP.
	...
	/**
	 * Return a Cursor positioned at the black list IP that matches the given
	 * rowId
	 * 
	 * @param rowId
	 *            id of black list IP to retrieve
	 * @return Cursor positioned to matching clack list IP, if found
	 * @throws SQLException
	 *             if black list IP could not be found/retrieved
	 */
	 ...
	 * @return true if the log entry was successfully updated, false otherwise
	 */
