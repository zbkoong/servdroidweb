...
public class ServDroid extends ListActivity {
	...
	public static final String REQUEST_PURCHASE_DONATION = "no_ads";// "android.test.purchased";
	// ////////////////////////
	...
	private void ShowDonateDialog(boolean showCanel) {
//		AlertDialog.Builder builder = new AlertDialog.Builder(this);
...
//		builder.show();
	...
	private boolean atLeastOneDonation() {
		...
		for (int i = 0; i < mItemsPurchased.size(); i++) {
			...
			if (tmp[0] != null && tmp[0].equals(REQUEST_PURCHASE_DONATION)) {
				return true;
			}
		}
		return false;
	...
	private void showThanksDonation() {
		Toast.makeText(this, R.string.thanks_you, Toast.LENGTH_LONG);
	}
